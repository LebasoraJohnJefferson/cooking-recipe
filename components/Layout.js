    ...
    <>
      ...
      <header >
        <div  className="bg-white drop-shadow h-max p-5 grid grid-row-1 grid-flow-col">
          <h1 className="flex items-center justify-self-center align-item-center"><Image src="/chef.svg" height={30} width={30} alt="chef icon"/>Cooking Recipe  For Everyone</h1>
